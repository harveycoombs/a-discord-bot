//Chirpp v2.59 - Harvey C. - https://github.com/harvey-x86/
...
client.on("guildCreate", guild => {
  ...
  .setFooter(`written in javascript by Harvey | @harvey-x86`, client.user.displayAvatarURL({format: 'png'}))
  .setTimestamp()
  ...
  switch(input) {
    ...
    case "info":
      ...
      const pms = require("pretty-ms");
        ...
        {name: ':information_source: Developed by:', value: `Harvey | @harvey-x86`, inline:true},
